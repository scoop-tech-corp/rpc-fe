...
const url = 'customer/datastatic';

export const getCustomerDataStatic = async (property) => {
...
export const deleteCustomerDataStatic = async (selectedRow) => await axios.delete(url, { data: { datas: selectedRow } });

// export const getDropdownCustomerDataStatic = async () => {
...
// export const saveCustomerDataStatic = async (data) => {
