...
import { deleteFinanceDataStatic, getFinanceDataStatic } from './service';
...
const FinanceStaticData = () => {
  ...
  const onConfirm = async (value) => {
    if (value) {
      await deleteFinanceDataStatic(selectedRow)
        .then((resp) => {
          if (resp.status === 200) {
            setDialog(false);
...
export default FinanceStaticData;
