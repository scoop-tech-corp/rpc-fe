...
import { deleteMenuSetting, getMenuSetting } from './service';
...
import FormMenuSetting from './form';
...
const MenuSetting = () => {
  ...
  const onConfirm = async (value) => {
    if (value) {
      await deleteMenuSetting(selectedRow)
        .then((resp) => {
          if (resp.status === 200) {
            setDialog(false);
  ...
  return (
    <>
      <HeaderPageCustom title={<FormattedMessage id="menu-setting" />} isBreadcrumb={true} />
