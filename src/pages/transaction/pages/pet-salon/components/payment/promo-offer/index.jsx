...
import { submitTransactionPetSalonDiscount } from '../../../service';
...
const PromoOfferTransactionPetSalon = (props) => {
  ...
  const onSubmit = async () => {
    ...
    try {
      const promoResponse = await submitTransactionPetSalonDiscount({
        transactionPetSalonId: promoData.transactionPetSalonId,
        freeItems: formValue.freeItems,
        discounts: formValue.discounts,
        bundles: formValue.bundles,
        basedSales: formValue.basedSales,
...
PromoOfferTransactionPetSalon.propTypes = {
  open: PropTypes.bool,
  data: PropTypes.object,
  onClose: PropTypes.func
};

export default PromoOfferTransactionPetSalon;
