...
const Payment = (props) => {
  ...
  // ── Validasi per-tab ────────────────────────────────────────────────────────
  const tab0Valid = formValue.recipeList.length === 0 || formValue.recipeList.every((r) => r.unitPrice > 0 && !r.unitPriceErr);
      ...
      >
        ...
        <TabPanel value={tabActive} index={0}>
          ...
          <SectionCard
            ...
            title={intl.formatMessage({ id: 'doctor-prescription' })}
          >
            {formValue.recipeList.length === 0 ? (
              <Alert severity="info" sx={{ borderRadius: 1 }}>
                <FormattedMessage id="no-prescription-transaction" />
              </Alert>
            ) : (
              <ScrollX>
