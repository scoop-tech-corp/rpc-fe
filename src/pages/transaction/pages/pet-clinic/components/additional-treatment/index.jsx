...
const AdditionalTreatmentPetClinic = (props) => {
  ...
  const onSubmit = async () => {
    ...
    setSubmitting(true);
    await addAdditionalTreatmentPetClinic({
      ...
      .then((resp) => {
        if (resp?.status === 201 || resp?.status === 200) {
          dispatch(snackbarSuccess('Tindakan tambahan berhasil ditambahkan'));
          setSelectedItem(null);
          setQuantity(1);
          setCatatan('');
          setSearchInput('');
        ...
        <Box sx={{ p: 2, border: 1, borderColor: 'divider', borderRadius: 1 }}>
          ...
          <FormControl component="fieldset">
            ...
            <RadioGroup row value={type} onChange={(e) => setType(e.target.value)}>
              ...
              <FormControlLabel value="product" control={<Radio size="small" />} label="Produk / Obat" />
            </RadioGroup>
          </FormControl>
...
AdditionalTreatmentPetClinic.propTypes = {
  open: PropTypes.bool,
  data: PropTypes.object,
  onClose: PropTypes.func
};

export default AdditionalTreatmentPetClinic;
