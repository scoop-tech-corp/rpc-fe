...
import { submitTransactionPetHotelDiscount } from '../../../service';
...
const PromoOfferTransactionPetHotel = (props) => {
  ...
  const onSubmit = async () => {
    ...
    try {
      const promoResponse = await submitTransactionPetHotelDiscount({
        transactionPetHotelId: promoData.transactionPetHotelId,
        freeItems: formValue.freeItems,
        discounts: formValue.discounts,
        bundles: formValue.bundles,
        basedSales: formValue.basedSales,
...
PromoOfferTransactionPetHotel.propTypes = {
  open: PropTypes.bool,
  data: PropTypes.object,
  onClose: PropTypes.func
};

export default PromoOfferTransactionPetHotel;
