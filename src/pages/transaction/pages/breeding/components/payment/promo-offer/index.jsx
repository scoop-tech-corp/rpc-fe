...
import { submitTransactionBreedingDiscount } from '../../../service';
...
const PromoOfferTransactionBreeding = (props) => {
  ...
  const onSubmit = async () => {
    ...
    try {
      const promoResponse = await submitTransactionBreedingDiscount({
        transactionBreedingId: promoData.transactionBreedingId,
        freeItems: formValue.freeItems,
        discounts: formValue.discounts,
        bundles: formValue.bundles,
        basedSales: formValue.basedSales,
...
PromoOfferTransactionBreeding.propTypes = {
  open: PropTypes.bool,
  data: PropTypes.object,
  onClose: PropTypes.func
};

export default PromoOfferTransactionBreeding;
