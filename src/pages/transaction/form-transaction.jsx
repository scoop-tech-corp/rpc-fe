...
const FormTransaction = (props) => {
  ...
  const [disabledOk] = useState(false);
  ...
  useEffect(() => {
    if (visitSource === 'booking' && bookingList.length === 0) {
      ...
      getBookingListTransaction({
        ...
        serviceType: TransactionType[type]
      })
        .then(setBookingList)
    ...
    <>
      ...
      >
        ...
        <Grid container spacing={3}>
          ...
          {(isEditForm || visitSource === 'walkIn') && ['hotel', 'pacak', 'clinic'].includes(formValue.configTransaction) && (
            <>
              <Grid item xs={12}>
                <Stack spacing={1}>
                  <InputLabel htmlFor="start-date">
          ...
          {(isEditForm || visitSource === 'walkIn') && ['clinic'].includes(formValue.configTransaction) && (
            <Grid item xs={12}>
              <Stack spacing={1}>
                <InputLabel>
