...
import { createEvent, deleteEvent, updateEvent } from '../store/reducer/index';
...
const AddEventFrom = ({ event, range, onCancel }) => {
  ...
  const deleteHandler = () => {
    ...
    dispatch(snackbarSuccess('Event deleted successfully.'));
  };
    ...
    onSubmit: (values, { setSubmitting }) => {
      try {
        ...
        if (event) {
          ...
          dispatch(snackbarSuccess('Event update successfully.'));
        } else {
          dispatch(createEvent(newEvent));
          dispatch(snackbarSuccess('Event add successfully.'));
        }
