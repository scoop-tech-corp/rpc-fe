...
import { defaultDetailAddress, useProductSupplierFormStore } from '../product-supplier-form-store';
...
const TabAddress = () => {
  ...
  const detailAddress = useProductSupplierFormStore((state) => state.detailAddress);
  const provinceList = useProductSupplierFormStore((state) => state.provinceList);
  ...
  const onSetLocationDetail = (data) => {
    ...
    useProductSupplierFormStore.setState({ detailAddress: newData, productSupplierFormTouch: true });
  };
