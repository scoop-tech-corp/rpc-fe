...
import { deleteProductDataStatic, getProductDataStatic } from './service';
...
const ProductStaticData = () => {
  ...
  const onConfirm = async (value) => {
    if (value) {
      await deleteProductDataStatic(selectedRow)
        .then((resp) => {
          if (resp.status === 200) {
            setDialog(false);
...
export default ProductStaticData;
