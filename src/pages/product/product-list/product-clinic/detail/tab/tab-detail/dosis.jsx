...
const Dosis = () => {
  const dosageList = useProductClinicDetailStore((state) => state.dosage);
  ...
  const processField = (key, getValue, i) => {
    useProductClinicDetailStore.setState((prevState) => {
      ...
      return { dosage: getData, productClinicDetailError: validationForm(key, getData, i), productClinicDetailTouch: true };
    });
  };
  ...
  const onAddDosage = () => {
    useProductClinicDetailStore.setState((prevState) => {
      return { dosage: [...prevState.dosage, { from: '', to: '', dosage: '', unit: '' }], productClinicDetailTouch: true };
    });
  };
  ...
  const onDeleteDosage = (i) => {
    useProductClinicDetailStore.setState((prevState) => {
      ...
      return { dosage: setNewData, productClinicDetailTouch: true };
    });
  };
