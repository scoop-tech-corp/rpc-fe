...
const ProductClinicDetailOverviewDescription = (props) => {
  const { data } = props;
...
ProductClinicDetailOverviewDescription.propTypes = {
  data: PropTypes.object
};

export default ProductClinicDetailOverviewDescription;
