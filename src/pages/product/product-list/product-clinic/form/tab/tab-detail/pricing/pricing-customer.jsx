...
const PricingCustomer = () => {
  const customerGroups = useProductClinicFormStore((state) => state.customerGroups);
  const customerGroupDropdown = useProductClinicFormStore((state) => state.dataSupport.customerGroupsList);
  ...
  const onSelectCustomerGroup = (e, i) => {
    useProductClinicFormStore.setState((prevState) => {
      ...
      return { customerGroups: getCustomGroup, productClinicFormTouch: true };
    });
  };
  ...
  const onAddCustomer = () => {
    useProductClinicFormStore.setState((prevState) => {
      ...
      return { customerGroups: setNewData, productClinicFormTouch: true };
    });
  };
