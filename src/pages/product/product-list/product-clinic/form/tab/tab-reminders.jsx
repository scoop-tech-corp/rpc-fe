...
const TabReminders = () => {
  const reminders = useProductClinicFormStore((state) => state.reminders);
  const timingList = [
  ...
  const onChangeHandler = (i, newObjReminder) => {
    useProductClinicFormStore.setState((prevState) => {
      ...
      return { reminders: getReminders, productClinicFormTouch: true };
    });
  };
  ...
  const onDeleteReminders = (i) => {
    useProductClinicFormStore.setState((prevState) => {
      ...
      return { reminders: newData, productClinicFormTouch: true };
    });
  };

  const onAddReminders = () => {
    useProductClinicFormStore.setState((s) => ({
