...
const Pricing = () => {
  const pricingStatus = useProductSellFormStore((state) => state.pricingStatus);

  const onChangePricing = (e) => useProductSellFormStore.setState({ pricingStatus: e.target.value, productSellFormTouch: true });
