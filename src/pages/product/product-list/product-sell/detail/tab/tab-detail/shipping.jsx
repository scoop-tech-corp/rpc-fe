...
const Shipping = () => {
  const isShipped = useProductSellDetailStore((state) => state.isShipped);
  const weight = useProductSellDetailStore((state) => state.weight);
  const length = useProductSellDetailStore((state) => state.length);
  const width = useProductSellDetailStore((state) => state.width);
  const height = useProductSellDetailStore((state) => state.height);
